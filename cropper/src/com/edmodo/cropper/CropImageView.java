...
//             mCropOverlayView.setBitmapRect(rect);
            //  here need to maintain state and reset this state on crop or cancel
    ...
    public void setImageBitmap(Bitmap bitmap, int orientation, boolean isFlip) {
        ...
        if(actualCropX>=0 && actualCropY >=0) {
            ...
            if(actualCropX<0 && actualCropY<0) {
                croppedBitmap = Bitmap.createBitmap(mBitmap,
                        ...
                        (int) actualCropWidth,
                        (int) actualCropHeight);
            }else if(actualCropX<0 && actualCropY >0){
                croppedBitmap = Bitmap.createBitmap(mBitmap,
                        0,
                        (int)actualCropY,
                        (int) actualCropWidth,
    ...
    public void setNewRectCoordinates(Rect rect){
        this.rect = rect;
